...
ECHO. 
ECHO Convert an XML file of spells to a PDF. The grimoire will include a preface, guidelines, and the spell list. The PDF will be named ars_magica_grimoire.pdf.
ECHO.
